...
extern "C" {
    int msiadd_vocab_metadata(msParam_t* _objPath, msParam_t* _resc, msParam_t* _attr_name, msParam_t* _attr_unit, msParam_t* _attr_type, ruleExecInfo_t* rei) {
        ...
        if (!add_metadata_to_vocabulary(obj_path, resc, attr_name, attr_unit, attr_type, rei)) {
